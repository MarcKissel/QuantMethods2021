...
### good pracitce is to use the date in the file name: 2020-02-03-My_text_draft
...
### - one example of a CSV editor is [**Data Curator**](https://github.com/qcif/data-curator/releases/tag/v1.2.5) 
...
1. everyone gets 2 eggs? put cand in each but not everyone gets the same type
