...
Healy 2019 data visualization chpt 1 (can help with homework!)

Wilke 2019 Fundementals of Data Viz, chpts 2-5 
...
---
#### Bubble Chart
understand relationship within groups based on a categorical var **and** a continous varibale 
...
???
At first sight, histograms may appear easy to understand, but research indicates otherwise (e.g., Lem, Onghena, Verschaffel, & Van
Dooren, 2014). In fact, many errors, misconceptions and mistakes in interpreting histograms have been documented in the literature
(e.g., Bruno & Espinel, 2009; Derouet & Parzysz, 2016; Friel et al., 2001; Kaplan, Gabrosek, Curtiss, & Malone, 2014; Lem, Onghena,
Verschaffel, & Van Dooren, 2013b). However, a systematic overview of these misinterpretations—a term we use as an umbrella for
the ways in which people interpret histograms incorrectly—has not yet been compiled. Research repeatedly showed the persistence of
the misinterpretations, despite various attempts to improve statistics education (e.g., Ben-Zvi & Garfield, 2004; Ben-Zvi et al., 2017;
Chance, del Mas, & Garfield, 2004; Cohen, 1996; Garfield & Ben-Zvi, 2007; Kaplan et al., 2014; Shaughnessy, 2007). Hence there is a
need to reflect on what conceptual difficulties may lie at the basis of these persistent misinterpretations. The aim of this review is
therefore to make an inventory of the misinterpretations that occur when people use histograms, as well as to categorise these
misinterpretations along the conceptual difficulties that become manifest in these misinterpretations. In this review, the word people
refers to students of all levels, as well as to teachers, researchers, teacher educators and others. The question guiding this review is:
What are the conceptual difficulties that become manifest in the common misinterpretations people have when constructing or
...
The graph shows the number of COVID-19 tests per million people. Flook at those bars: Argentina tests almost as many people as the USA! At least that’s what it seems like until you look at the numbers. 
---
![](https://miro.medium.com/max/768/1*2XZ667k6b_haq-jrHb58HQ.png)


---

![](https://storage.ning.com/topology/rest/1.0/file/get/8259702852?profile=RESIZE_710x)
...
![](https://assets.weforum.org/editor/responsive_large_webp_2xoUO5D7IwC3YkGQwpTkJmP2rywJohRgFxvMsdKjRmk.webp)
???
