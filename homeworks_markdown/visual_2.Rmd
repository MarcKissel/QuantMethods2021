...
>
> Rather than a normal handout/lab this one tells a story and has you learning ggplot while you do so. Be sure to check out the reading here: <https://r4ds.had.co.nz/data-visualisation.html> before doing this project. If you need more background on how ggplot works check out chpt 3 of <https://socviz.co/makeplot.html#makeplot> "Data Visualization"
>
...
![](The-Isle-of-Naboombu.png "the mysterious island of Naboombu")
...
We are going to be simulating the data you collected!
...
```{r ANSWER TO Q3}
all_data %>% ggplot(aes(tail_length, fill=monkey_pop)) + geom_histogram( alpha=0.6, position = 'identity') + scale_fill_manual(values=c("green", "yellow"))
```
...
# [What else can you do with R visualizations]{.ul}
